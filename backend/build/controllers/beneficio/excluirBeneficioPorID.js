...
exports.excluirBeneficioPorID = void 0;
const connection_1 = __importDefault(require("../../connection"));
const Authenticator_1 = require("../../services/midleware/Authenticator");
const excluirBeneficioPorID = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield (0, connection_1.default)('beneficio').where('id_beneficio', id_beneficio).del();
...
exports.excluirBeneficioPorID = excluirBeneficioPorID;
//# sourceMappingURL=excluirBeneficioPorID.js.map